...
_lr_productions = [
  ...
  ('start -> create ENDREQUEST','start',2,'p_start','SQL_parser.py',218),
  ('start -> show ENDREQUEST','start',2,'p_start','SQL_parser.py',219),
  ('start -> drop ENDREQUEST','start',2,'p_start','SQL_parser.py',220),
  ('start -> tree_selects ENDREQUEST','start',2,'p_start','SQL_parser.py',221),
  ('start -> insert ENDREQUEST','start',2,'p_start','SQL_parser.py',222),
  ('start -> update ENDREQUEST','start',2,'p_start','SQL_parser.py',223),
  ('start -> delete ENDREQUEST','start',2,'p_start','SQL_parser.py',224),
  ('create -> CREATE create_body','create',2,'p_create','SQL_parser.py',231),
  ('create_body -> TABLE NAME LBRACKET values RBRACKET','create_body',5,'p_create_body','SQL_parser.py',237),
  ('values -> NAME type','values',2,'p_values','SQL_parser.py',243),
  ('values -> values COMMA NAME type','values',4,'p_values','SQL_parser.py',244),
  ('show -> SHOW CREATE TABLE NAME','show',4,'p_show','SQL_parser.py',255),
  ('drop -> DROP TABLE NAME','drop',3,'p_drop','SQL_parser.py',261),
  ('tree_selects -> nested_selects','tree_selects',1,'p_tree_selects','SQL_parser.py',266),
  ('nested_selects -> select join nested_selects','nested_selects',3,'p_nested_selects','SQL_parser.py',272),
  ('nested_selects -> select UNION nested_selects','nested_selects',3,'p_nested_selects','SQL_parser.py',273),
  ('nested_selects -> select INTERSECT nested_selects','nested_selects',3,'p_nested_selects','SQL_parser.py',274),
  ('nested_selects -> select','nested_selects',1,'p_nested_selects','SQL_parser.py',275),
  ('join -> JOIN','join',1,'p_join','SQL_parser.py',287),
  ('join -> LEFT JOIN','join',2,'p_join','SQL_parser.py',288),
  ('join -> RIGHT JOIN','join',2,'p_join','SQL_parser.py',289),
  ('join -> OUTER JOIN','join',2,'p_join','SQL_parser.py',290),
  ('join -> LEFT OUTER JOIN','join',3,'p_join','SQL_parser.py',291),
  ('join -> RIGHT OUTER JOIN','join',3,'p_join','SQL_parser.py',292),
  ('select -> SELECT select_body','select',2,'p_select','SQL_parser.py',304),
  ('select -> SELECT select_body condition','select',3,'p_select','SQL_parser.py',305),
  ('select_body -> fields FROM NAME','select_body',3,'p_select_body','SQL_parser.py',314),
  ('select_body -> STAR COMMA fields FROM NAME','select_body',5,'p_select_body','SQL_parser.py',315),
  ('select_body -> STAR FROM NAME','select_body',3,'p_select_body','SQL_parser.py',316),
  ('insert -> INSERT insert_body','insert',2,'p_insert','SQL_parser.py',327),
  ('insert_body -> INTO NAME VALUES LBRACKET fields RBRACKET','insert_body',6,'p_insert_body','SQL_parser.py',333),
  ('insert_body -> INTO NAME LBRACKET fields RBRACKET VALUES LBRACKET fields RBRACKET','insert_body',9,'p_insert_body','SQL_parser.py',334),
  ('update -> UPDATE update_body','update',2,'p_update','SQL_parser.py',343),
  ('update_body -> NAME SET expression','update_body',3,'p_update_body','SQL_parser.py',349),
  ('update_body -> NAME SET expression condition','update_body',4,'p_update_body','SQL_parser.py',350),
  ('expression -> field EQUAL tree_expression','expression',3,'p_expression','SQL_parser.py',359),
  ('expression -> expression COMMA field EQUAL tree_expression','expression',5,'p_expression','SQL_parser.py',360),
  ('delete -> DELETE FROM NAME','delete',3,'p_delete','SQL_parser.py',373),
  ('delete -> DELETE FROM NAME condition','delete',4,'p_delete','SQL_parser.py',374),
  ('fields -> NAME','fields',1,'p_fields','SQL_parser.py',382),
  ('fields -> fields COMMA NAME','fields',3,'p_fields','SQL_parser.py',383),
  ('field -> NAME','field',1,'p_field','SQL_parser.py',394),
  ('condition -> WHERE tree_condition','condition',2,'p_condition','SQL_parser.py',400),
  ('tree_condition -> tree_comparison operator_condition tree_condition','tree_condition',3,'p_tree_condition','SQL_parser.py',406),
  ('tree_condition -> tree_comparison','tree_condition',1,'p_tree_condition','SQL_parser.py',407),
  ('tree_comparison -> tree_expression operator_comparison tree_expression','tree_comparison',3,'p_tree_comparison','SQL_parser.py',421),
  ('tree_expression -> field','tree_expression',1,'p_tree_expression','SQL_parser.py',429),
  ('tree_expression -> field operator_expression tree_expression','tree_expression',3,'p_tree_expression','SQL_parser.py',430),
  ('tree_expression -> operator_expression tree_expression','tree_expression',2,'p_tree_expression','SQL_parser.py',431),
  ('tree_expression -> LBRACKET tree_expression RBRACKET','tree_expression',3,'p_tree_expression','SQL_parser.py',432),
  ('tree_expression -> tree_expression operator_expression tree_expression','tree_expression',3,'p_tree_expression','SQL_parser.py',433),
  ('operator_condition -> AND','operator_condition',1,'p_operator_condition','SQL_parser.py',445),
  ('operator_condition -> OR','operator_condition',1,'p_operator_condition','SQL_parser.py',446),
  ('operator_comparison -> EQUAL','operator_comparison',1,'p_operator_comparison','SQL_parser.py',452),
  ('operator_comparison -> NOT_EQUAL','operator_comparison',1,'p_operator_comparison','SQL_parser.py',453),
  ('operator_comparison -> GREATER_THAN','operator_comparison',1,'p_operator_comparison','SQL_parser.py',454),
  ('operator_comparison -> LESS_THAN','operator_comparison',1,'p_operator_comparison','SQL_parser.py',455),
  ('operator_comparison -> GREATER_THAN_OR_EQUAL','operator_comparison',1,'p_operator_comparison','SQL_parser.py',456),
  ('operator_comparison -> LESS_THAN_OR_EQUAL','operator_comparison',1,'p_operator_comparison','SQL_parser.py',457),
  ('operator_expression -> PLUS','operator_expression',1,'p_operator_expression','SQL_parser.py',463),
  ('operator_expression -> MINUS','operator_expression',1,'p_operator_expression','SQL_parser.py',464),
  ('operator_expression -> STAR','operator_expression',1,'p_operator_expression','SQL_parser.py',465),
  ('operator_expression -> DIVISION','operator_expression',1,'p_operator_expression','SQL_parser.py',466),
  ('type -> int','type',1,'p_type','SQL_parser.py',472),
  ('type -> str','type',1,'p_type','SQL_parser.py',473),
  ('type -> bol','type',1,'p_type','SQL_parser.py',474),
  ('type -> bool','type',1,'p_type','SQL_parser.py',475),
  ('type -> float','type',1,'p_type','SQL_parser.py',476),
]
