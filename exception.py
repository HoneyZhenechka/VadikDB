...
class DBFileNotExists(DBException):
    def __init__(self):
        self.error_code = "00"
        print("Error code: " + self.error_code + " -- DB file not exists!")
...
class WrongSignature(DBException):
    def __init__(self):
        self.error_code = "02"
        print("Error code: " + self.error_code + " -- Wrong signature!")
